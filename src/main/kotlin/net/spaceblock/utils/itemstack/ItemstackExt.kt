...
package net.spaceblock.utils.itemstack
...
import net.spaceblock.utils.chat.ChatColors
...
fun toLoreList(string: String, lineColor: TextColor = ChatColors.WHITE, vararg lineDecorations: TextDecoration = arrayOf(), lineLength: Int = 40): List<Component> {
    val loreList = ArrayList<Component>()
